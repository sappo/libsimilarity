...
* dist_levenshtein:
    ...
    def compare(self, x, y):
        ...
        """
        return lib.measures_compare(self._p, x._p, y._p)

    def config_set_string(self, key, value):
        """
        Sets a string configuration
        """
        return lib.measures_config_set_string(self._p, to_bytes(key), to_bytes(value))

    def config_set_int(self, key, value):
        """
        Sets an integer configuration
        """
        return lib.measures_config_set_int(self._p, to_bytes(key), value)

    def config_set_float(self, key, value):
        """
        Sets an float configuration
        """
        return lib.measures_config_set_float(self._p, to_bytes(key), value)

    def config_set_bool(self, key, value):
        """
        Sets an integer configuration
        """
        return lib.measures_config_set_bool(self._p, to_bytes(key), value)
    ...
    def match(name):
        ...
        otherwise 0.                                                         
        """
        return lib.measures_match(to_bytes(name))
    ...
    def config(self, name):
        ...
        """
        return lib.measures_config(self._p, to_bytes(name))

    def test(verbose):
        """
        Self test of this class.
        """
        return lib.measures_test(verbose)
